...
| [MOBILE_PENDEV_REDESIGN.md](./MOBILE_PENDEV_REDESIGN.md)                                                 | **← Redesign visual mobile lagi jalan di `assets/design/mobile.pen`** — status, sistem desain, gotcha pen.dev wajib dibaca sebelum lanjut edit |
| [MOBILE_USE_CASE_FLOWS.md](./MOBILE_USE_CASE_FLOWS.md)                                                   | Katalog tabel 25 Use Case + UI Flow (usecase, alur tap, layar, grounding screenshot)                                                           |
...
| [reviews/2026-09-24-mobile-app-screenshot-baseline.md](./reviews/2026-09-24-mobile-app-screenshot-baseline.md)             | Baseline screenshot baru mobile app (native emulator, bukan web export): 30 screen Classic+Modern, gantiin baseline lama yang basi |
