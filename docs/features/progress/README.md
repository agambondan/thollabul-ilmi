...
Folder ini berisi feature yang sedang dikerjakan atau masih bergerak.

## Task Breakdown Aktif

| Dokumen | Fokus |
|---|---|
| [2026-05-24-mobile-web-app-layout-impact-plan.md](./2026-05-24-mobile-web-app-layout-impact-plan.md) | Impact plan task #5 untuk layout `web_app` mobile: rollout aman, risk register, dan acceptance criteria sebelum visual redesign |
...
- gunakan status `IN_PROGRESS` atau `VERIFIED`
- catat evidence terakhir yang benar-benar sudah dijalankan
- pindahkan ke `../done/` hanya setelah scope tertutup dan evidence jelas
