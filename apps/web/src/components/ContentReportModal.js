...
const CATEGORIES = [
    {
        ...
        labelId: "Kesalahan Terjemahan",
        labelEn: "Translation Error",
    },
    {
        value: "arabic_text_error",
        labelId: "Kesalahan Teks Arab/Harakat",
        labelEn: "Arabic/Harakat Error",
    },
    {
        value: "tafsir_error",
        labelId: "Kekeliruan Tafsir/Penjelasan",
        labelEn: "Tafsir Error",
    },
    {
        value: "sanad_grading_error",
        labelId: "Derajat Hadits/Sanad Salah",
        labelEn: "Grading/Sanad Error",
    },
                        ...
                        <div>
                            <label className='block text-xs font-semibold text-gray-700 dark:text-gray-300 mb-1'>
                                {lang === "EN"
                                    ...
                                    : "Usulan Koreksi / Terjemahan yang Benar (opsional)"}
                            </label>
                            <textarea
                                rows={2}
                                value={correction}
