        ...
        >
            <div className='flex flex-wrap items-start justify-between gap-3'>
                ...
                <div className='text-right text-xs font-bold text-slate-700 dark:text-slate-200'>
                    {hijriDate ? (
                        <p className='flex items-center justify-end gap-1 text-emerald-700 dark:text-emerald-400'>
            ...
            <div className='py-7 text-center'>
                ...
                <div className='mt-4 inline-flex items-center gap-1.5 rounded-xl border border-emerald-100 bg-emerald-50 px-3 py-2 text-sm font-extrabold text-emerald-800 dark:text-emerald-300 shadow-sm dark:border-emerald-900/40 dark:bg-emerald-900/20'>
                    <MdAccessTime className='text-emerald-700 dark:text-emerald-400' />
