...
export default function InlineError({ onRetry, message }) {
    ...
    return (
        <div
            role='alert'
            aria-live='assertive'
            className='flex flex-wrap items-center justify-center gap-3 rounded-xl border border-red-100 bg-red-50/60 px-4 py-3 text-sm text-red-700 dark:text-red-400 dark:border-red-900/40 dark:bg-red-900/10 dark:text-red-300'
        >
