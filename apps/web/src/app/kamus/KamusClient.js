        ...
        <div className='max-w-3xl mx-auto px-4 py-8'>
            ...
            <div className='flex gap-2 mb-6'>
                <div className='relative flex-1'>
                    <svg width='1em' height='1em' viewBox='0 0 16 16' fill='currentColor' className='absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-400 text-sm' aria-hidden='true'><path d='M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z' /></svg>
                    <input
                        type='text'
                        value={query}
                        onChange={(e) => {
