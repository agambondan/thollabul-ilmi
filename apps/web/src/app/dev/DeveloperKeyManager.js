        ...
        <div className='space-y-5'>
            <div className={`${cardCls} p-6`}>
                <div className='flex items-start justify-between gap-4'>
                    <div>
                        <div className='inline-flex items-center gap-2 rounded-full bg-emerald-50 px-3 py-1 text-xs font-semibold text-emerald-700 dark:text-emerald-400 dark:bg-emerald-900/20'>
                            <BsKey />
                            Developer Access
                        </div>
            ...
            {error && (
                <div className='rounded-2xl border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700 dark:text-red-400 dark:border-red-900/40 dark:bg-red-900/20'>
                    {error}
                </div>
            )}
