...
export default function DevPageClient() {
    ...
    return (
        ...
        >
            ...
            <div className='mb-8 bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded-xl px-4 py-3 text-sm text-emerald-800 dark:text-emerald-300'>
