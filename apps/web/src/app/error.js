    ...
    return (
        <div className='min-h-screen bg-parchment-50 dark:bg-slate-900 flex items-center justify-center px-4'>
            <div className='text-center max-w-md'>
                ...
                <p className='text-sm text-gray-500 dark:text-gray-300 dark:text-gray-400 mb-6 leading-relaxed'>
                ...
                <div className='flex gap-3 justify-center'>
                    ...
                    <Link
                        href={homeHref}
                        className='border border-emerald-300 dark:border-emerald-700 text-emerald-700 dark:text-emerald-400 dark:text-emerald-300 hover:bg-emerald-50 dark:hover:bg-emerald-900/30 text-sm px-5 py-2 rounded-full transition-colors'
                    >
                        {t("not_found.home")}
                    </Link>
                </div>
