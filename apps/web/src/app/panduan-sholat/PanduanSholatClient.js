    ...
    return (
        <ContentWidth compact='max-w-2xl' className='flex-1 px-4 pt-6 pb-8'>
            ...
            <div className='mb-8 text-center'>
                ...
                <h1 className='text-3xl font-extrabold text-emerald-900 dark:text-emerald-300 mb-2'>
                    {t("link.prayer_guide")}
                </h1>
                                ...
                                >
                                    ...
                                    >
                                        <div className='flex items-center gap-3'>
                                            <span className='w-7 h-7 rounded-full bg-emerald-100 dark:bg-emerald-900/40 text-emerald-700 dark:text-emerald-400 text-xs font-extrabold flex items-center justify-center flex-shrink-0'>
                                                {si + 1}
                                            </span>
