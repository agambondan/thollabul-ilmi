...
export const BlogDetailContent = ({
    ...
    const hydratedSlugRef = useRef(
        initialPost && (initialPost.slug ?? params.slug) === params.slug
            ? params.slug
            : null,
    );
    ...
    useEffect(() => {
        ...
        const load = async () => {
            ...
            try {
                ...
                if (isActive && !skipResetForSsrHydration) setError(true);
            } finally {
                        ...
                        <article className='bg-white dark:bg-slate-900 rounded-3xl border border-gray-100 dark:border-slate-800 shadow-sm overflow-hidden'>
                            ...
                            <div className='p-6 md:p-10'>
                                <div className='flex flex-wrap items-center gap-2.5 mb-4'>
                                    {postCategoryLabel && (
                                        <span className='px-3 py-1 bg-emerald-50 dark:bg-emerald-950/50 text-emerald-700 dark:text-emerald-400 rounded-full text-xs font-semibold uppercase tracking-wider'>
                                            {postCategoryLabel}
                                        </span>
                                    )}
                                    {stats.minutes > 0 && (
                                        ...
                                        {post.tags.map((tag) => {
                                            ...
                                            return (
                                                <span
                                                    ...
                                                    className='px-3 py-1 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 text-gray-600 dark:text-gray-300 rounded-full text-xs font-medium hover:border-emerald-400 dark:hover:border-emerald-600 transition-colors'
                                                >
                                                    #{tagLabel}
                                                </span>
                                            );
                        ...
                        <div className='bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800 p-5 shadow-sm'>
                            ...
                            <div className='grid grid-cols-2 gap-2 text-xs'>
                                <button
                                    ...
                                    className='flex items-center gap-2 px-3 py-2 rounded-xl bg-emerald-50 dark:bg-emerald-950/40 text-emerald-700 dark:text-emerald-400 font-medium hover:bg-emerald-100 dark:hover:bg-emerald-950/70 transition-colors'
                                >
                                ...
                                <button
                                    ...
                                    className='flex items-center gap-2 px-3 py-2 rounded-xl bg-blue-50 dark:bg-blue-950/40 text-blue-700 dark:text-blue-400 font-medium hover:bg-blue-100 dark:hover:bg-blue-950/70 transition-colors'
                                >
                                    <BsEnvelope />
                                    {t("blog.share_email")}
                                </button>
