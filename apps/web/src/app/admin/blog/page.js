        ...
        <div className='p-6 md:p-8 w-full'>
            ...
            <div className='flex flex-wrap gap-3 mb-6'>
                ...
                <div className='flex items-center gap-2'>
                    <div className='flex items-center gap-1.5 px-3 py-2 rounded-xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-xs text-gray-500 dark:text-gray-300'>
                        <BsFilter />
                        <select
                            value={statusFilter}
                ...
                <div className='bg-white dark:bg-slate-800 rounded-3xl border border-gray-100 dark:border-slate-700 p-6 shadow-sm'>
                    ...
                    <div className='flex flex-wrap gap-2 max-h-60 overflow-y-auto pr-1'>
                        {tags.map((tag) => (
                            <span
                                key={tag.id}
                                className='flex items-center gap-1.5 px-3 py-1.5 bg-gray-50 dark:bg-slate-700/60 text-gray-600 dark:text-gray-300 rounded-full text-xs font-medium border border-gray-200 dark:border-slate-600'
                            >
                                #{tag.name}
                                <button
