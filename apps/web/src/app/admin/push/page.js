        ...
        try {
            ...
            if (!res.ok) {
                ...
                throw new Error(
                    errData.message ||
                        errData.error ||
                        "Gagal mengirim broadcast notifikasi.",
                );
            }
        ...
        <div className='p-6 w-full'>
            <div className='mb-6'>
                ...
                <p className='text-sm text-gray-500 dark:text-gray-400 mt-1'>
                    Kirim notifikasi push langsung ke browser, PWA, dan
                    perangkat mobile yang telah terdaftar.
                </p>
            </div>
                    ...
                    <div className='text-sm'>
                        {result.ok ? (
                            <p>
                                ...
                                Terkirim ke <strong>{result.sent}</strong>{" "}
                                perangkat aktif (dari {result.tokens} total
                                token terdaftar).
                            </p>
                        ) : (
                            <p>
                                <strong>Gagal mengirim broadcast:</strong>{" "}
                                {result.error}
                            </p>
                        )}
                    </div>
            ...
            <form
                onSubmit={handleSend}
                className='bg-white dark:bg-slate-800 rounded-2xl border border-gray-100 dark:border-slate-700 p-5 space-y-4 shadow-sm'
            >
                <div>
                ...
                <div>
                    ...
                    <p className='text-xs text-gray-400 mt-1'>
                        Gunakan URL internal seperti <code>/jadwal-sholat</code>
                        , <code>/dashboard</code>, atau URL lengkap.
                    </p>
                </div>
