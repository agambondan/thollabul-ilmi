            ...
            <section className='mb-8'>
                <div className='mb-3 flex items-end justify-between gap-4'>
                    ...
                    {overview.failed > 0 && !overview.loading ? (
                        <span className='rounded-full bg-amber-50 px-2.5 py-1 text-xs font-medium text-amber-700 dark:text-amber-400 dark:bg-amber-900/20'>
                    ...
                    <div className='grid grid-cols-1 gap-3 md:grid-cols-2'>
                        {overview.reviewQueue.map((item) => (
                            ...
                            >
                                ...
                                <div className='mt-3 flex items-center justify-between text-xs font-medium text-emerald-700 dark:text-emerald-400 opacity-0 transition-opacity group-hover:opacity-100'>
