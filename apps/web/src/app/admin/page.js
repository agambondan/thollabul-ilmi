                                        ...
                                        <div className='grid grid-cols-2 gap-2'>
                                            {Object.entries(groups).map(
                                                ([source, pages]) => (
                                                    <div
                                                        key={source}
                                                        className='rounded-lg border border-gray-50 bg-gray-50/50 p-2 dark:border-slate-600 dark:bg-slate-700/30'
                                                    >
