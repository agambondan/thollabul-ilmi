    ...
    return (
        <div className='min-h-screen bg-gray-50 dark:bg-gray-950 flex items-center justify-center px-4'>
            <div className='text-center max-w-md bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800 shadow-sm px-6 py-10'>
                <div className='text-8xl font-black text-emerald-100 dark:text-emerald-900 leading-none mb-2 select-none'>
                    404
                </div>
                ...
                <div className='flex flex-wrap gap-2 justify-center mb-8'>
                    {QUICK_LINKS.map((link) => (
                        <Link
                            ...
                            className='text-xs px-4 py-2 rounded-full border border-emerald-200 dark:border-emerald-800 text-emerald-700 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-900/30 transition-colors'
                        >
                            {t(link.labelKey)}
                        </Link>
                    ))}
