            ...
            <div className='mb-6'>
                {token ? (
                    ...
                    <Link
                        ...
                        className='block text-center py-3 px-4 bg-white dark:bg-slate-800 border-2 border-dashed border-gray-200 dark:border-slate-700 rounded-2xl text-sm text-gray-400 hover:border-emerald-300 hover:text-emerald-700 hover:dark:text-emerald-400 transition-colors'
                    >
