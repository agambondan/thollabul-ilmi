...
const CATEGORIES = [
    ...
    { value: "wudhu", labelKey: "doa.cat.wudhu" },
    { value: "pakaian", labelKey: "doa.cat.clothing" },
    { value: "rumah", labelKey: "doa.cat.house" },
    { value: "sakit", labelKey: "doa.cat.sick" },
    { value: "keluarga", labelKey: "doa.cat.family" },
    { value: "hujan", labelKey: "doa.cat.rain" },
    { value: "puasa", labelKey: "doa.cat.fasting" },
    { value: "jenazah", labelKey: "doa.cat.funeral" },
    { value: "dzikir_pagi", labelKey: "doa.cat.dzikir_morning" },
    { value: "dzikir_petang", labelKey: "doa.cat.dzikir_evening" },
    { value: "dzikir_setelah_sholat", labelKey: "doa.cat.dzikir_after_prayer" },
    { value: "dzikir_tidur", labelKey: "doa.cat.dzikir_sleep" },
    { value: "istighfar", labelKey: "doa.cat.istighfar" },
    { value: "sholawat", labelKey: "doa.cat.sholawat" },
