                    ...
                    <SettingRow label={t("settings.notif_adzan")}>
                        <div className='flex items-center gap-3'>
                            ...
                            <button
                                ...
                                className='px-2.5 py-1 text-xs rounded-lg border border-emerald-200 dark:border-emerald-800 text-emerald-700 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-900/30 transition-colors'
                            >
