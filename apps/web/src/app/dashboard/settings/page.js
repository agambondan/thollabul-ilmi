                ...
                <section className='bg-white dark:bg-slate-800 rounded-2xl border border-gray-100 dark:border-slate-700 p-5'>
                    ...
                    <SettingRow label={t('settings.theme')}>
                        <select 
                            ...
                            className='bg-gray-50 dark:bg-slate-900 border border-gray-200 dark:border-slate-700 text-sm rounded-lg px-3 py-1.5 focus:ring-emerald-500'
                        >
                ...
                <section className='bg-white dark:bg-slate-800 rounded-2xl border border-gray-100 dark:border-slate-700 p-5'>
                    ...
                    <SettingRow label={t('settings.quran_font')}>
                        <select 
                            ...
                            onChange={(e) => updateSetting('quranFont', e.target.value)}
                            className='bg-gray-50 dark:bg-slate-900 border border-gray-200 dark:border-slate-700 text-sm rounded-lg px-3 py-1.5 focus:ring-emerald-500'
                        >
                    ...
                    <SettingRow label={t('settings.reader_size')}>
                        <input 
                            ...
                            onChange={(e) => updateSetting('readerSize', Number(e.target.value))}
                            className='w-32 accent-emerald-600'
                        />
                        <span className='ml-2 text-xs text-gray-500 w-8'>{settings.readerSize}px</span>
                    </SettingRow>
                </section>
                ...
                <section className='bg-white dark:bg-slate-800 rounded-2xl border border-gray-100 dark:border-slate-700 p-5'>
                    ...
                    <SettingRow label={t('settings.notif_adzan')}>
                        <input 
                            ...
                            onChange={(e) => updateSetting('notifAdzan', e.target.checked)}
                    ...
                    <SettingRow label={t('settings.notif_kajian')}>
                        <input 
                            ...
                            onChange={(e) => updateSetting('notifKajian', e.target.checked)}
                            className='w-4 h-4 text-emerald-600 bg-gray-100 border-gray-300 rounded focus:ring-emerald-500 dark:focus:ring-emerald-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600'
                        />
                    </SettingRow>
                </section>
