    ...
    return (
        <div className='px-4 py-6'>
            ...
            <div className='grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6'>
                {QUICK_LINKS.map((item) => (
                    ...
                    >
                        ...
                        <span className='text-[11px] font-medium text-gray-600 dark:text-gray-300 group-hover:text-emerald-700 hover:dark:text-emerald-400 dark:group-hover:text-emerald-400 transition-colors leading-tight'>
                            {t(item.labelKey)}
                        </span>
                    </Link>
                ))}
            ...
            <div className='mt-6 bg-emerald-700 dark:bg-emerald-800 rounded-xl p-5 flex items-center justify-between gap-4'>
                ...
                <Link
                    href='/dashboard/muhasabah'
                    className='flex-shrink-0 flex items-center gap-1.5 px-4 py-2 bg-white text-emerald-700 dark:text-emerald-400 rounded-lg text-sm font-medium hover:bg-emerald-50 transition-colors'
                >
                    <BsPencilSquare />
                    {t("common.write")}
                </Link>
