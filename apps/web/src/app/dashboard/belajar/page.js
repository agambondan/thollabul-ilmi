...
export default function BelajarPage({ basePath = "/dashboard" }) {
    ...
    const MODULES = [
        {
            labelKey: "belajar.mod.lessons",
            href: lessonsHref,
            icon: <BsPlayFill className='text-xl text-emerald-600' />,
            descKey: "belajar.mod.lessons_d",
        },
        {
            labelKey: "belajar.mod.kajian",
            href: `${root}/kajian`,
            icon: <MdOutlinePlayLesson className='text-xl text-blue-500' />,
            descKey: "belajar.mod.kajian_d",
        },
        {
            labelKey: "belajar.mod.fiqh",
            href: `${root}/fiqh`,
            icon: <MdMenuBook className='text-xl text-amber-500' />,
            descKey: "belajar.mod.fiqh_d",
        },
        {
            labelKey: "belajar.mod.siroh",
            href: `${root}/siroh`,
            icon: <MdOutlineAutoStories className='text-xl text-rose-500' />,
            descKey: "belajar.mod.siroh_d",
        },
        {
            labelKey: "belajar.mod.sejarah",
            href: `${root}/sejarah`,
            icon: <MdTimeline className='text-xl text-indigo-500' />,
            descKey: "belajar.mod.sejarah_d",
        },
        {
            labelKey: "belajar.mod.kamus",
            href: `${root}/kamus`,
            icon: <BsBook className='text-xl text-teal-500' />,
            descKey: "belajar.mod.kamus_d",
        },
        {
            labelKey: "belajar.mod.quiz",
            href: `${root}/quiz`,
            icon: <FaBrain className='text-xl text-purple-500' />,
            descKey: "belajar.mod.quiz_d",
        },
        {
            labelKey: "belajar.mod.library",
            href: `${root}/library`,
