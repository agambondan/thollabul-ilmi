...
export const authFetch = async (path, options = {}) => {
    ...
    try {
        ...
        if (
            ...
            notifyAdminMutationError(
                error.message || adminMutationFallback(method),
            );
        }
        throw error;
    }
...
export const userApi = {
    ...
    revokeSession: (id) =>
        authFetch(`/api/v1/auth/sessions/${id}`, { method: "DELETE" }),
...
export const adminAnalyticsApi = {
    summary: (days = 14) =>
        authFetch(`/api/v1/analytics/admin/summary?days=${days}`),
};
...
export const searchApi = {
    search: (q, type = "all", lang = "id", page = 0, limit = 20) =>
        fetch(
            `${API_URL}/api/v1/search?q=${encodeURIComponent(q)}&type=${type}&lang=${lang}&page=${page}&limit=${limit}`,
        ),
};
...
export const tafsirApi = {
    ...
    search: (q) =>
        fetch(`${API_URL}/api/v1/tafsir/search?q=${encodeURIComponent(q)}`),
};
...
export const mufrodatApi = {
    ...
    byRoot: (word) =>
        fetch(`${API_URL}/api/v1/mufrodat/root/${encodeURIComponent(word)}`),
};

export const audioApi = {
    bySurah: (surahNumber) =>
        fetch(`${API_URL}/api/v1/audio/surah/${surahNumber}`),
...
export const adminBlogApi = {
    listAll: (status = "") =>
        authFetch(
            `/api/v1/blog/posts${status ? `?status=${status}` : "?status=all"}`,
        ),
    create: (data) =>
        authFetch("/api/v1/blog/posts", {
            method: "POST",
            body: JSON.stringify(data),
        }),
    update: (id, data) =>
        authFetch(`/api/v1/blog/posts/${id}`, {
            method: "PUT",
            body: JSON.stringify(data),
        }),
    delete: (id) => authFetch(`/api/v1/blog/posts/${id}`, { method: "DELETE" }),
    createCategory: (data) =>
        authFetch("/api/v1/blog/categories", {
            method: "POST",
            body: JSON.stringify(data),
        }),
    updateCategory: (id, data) =>
        authFetch(`/api/v1/blog/categories/${id}`, {
            method: "PUT",
            body: JSON.stringify(data),
        }),
    deleteCategory: (id) =>
...
export const adminSirohApi = {
    ...
    createCategory: (data) =>
        authFetch("/api/v1/siroh/categories", {
            method: "POST",
            body: JSON.stringify(data),
        }),
    updateCategory: (id, data) =>
        authFetch(`/api/v1/siroh/categories/${id}`, {
            method: "PUT",
            body: JSON.stringify(data),
        }),
    deleteCategory: (id) =>
    ...
    createContent: (data) =>
        authFetch("/api/v1/siroh/contents", {
            method: "POST",
            body: JSON.stringify(data),
        }),
    updateContent: (id, data) =>
        authFetch(`/api/v1/siroh/contents/${id}`, {
            method: "PUT",
            body: JSON.stringify(data),
        }),
    deleteContent: (id) =>
...
export const muhasabahApi = {
    ...
    create: (data) =>
        authFetch("/api/v1/muhasabah", {
            method: "POST",
            body: JSON.stringify(data),
        }),
    update: (id, data) =>
        authFetch(`/api/v1/muhasabah/${id}`, {
            method: "PUT",
            body: JSON.stringify(data),
        }),
...
export const wiridApi = {
    ...
    byOccasion: (occasion) =>
        fetch(
            `${API_URL}/api/v1/wirid/occasion/${encodeURIComponent(occasion)}`,
        ),
};
...
export const adminDoaApi = {
    list: (page = 0, size = 100) =>
        authFetch(`/api/v1/doa?page=${page}&size=${size}`),
    create: (data) =>
        authFetch("/api/v1/doa", {
            method: "POST",
            body: JSON.stringify(data),
        }),
    update: (id, data) =>
        authFetch(`/api/v1/doa/${id}`, {
            method: "PUT",
            body: JSON.stringify(data),
        }),
...
export const adminReminderApi = {
    list: (page = 0, size = 100) =>
        authFetch(
            `/api/v1/reminders/admin?page=${page}&size=${size}&active=all`,
        ),
    create: (data) =>
        authFetch("/api/v1/reminders", {
            method: "POST",
            body: JSON.stringify(data),
        }),
    update: (id, data) =>
        authFetch(`/api/v1/reminders/${id}`, {
            method: "PUT",
            body: JSON.stringify(data),
        }),
...
export const adminDzikirApi = {
    list: (page = 0, size = 100) =>
        authFetch(`/api/v1/dzikir?page=${page}&size=${size}`),
    create: (data) =>
        authFetch("/api/v1/dzikir", {
            method: "POST",
            body: JSON.stringify(data),
        }),
    update: (id, data) =>
        authFetch(`/api/v1/dzikir/${id}`, {
            method: "PUT",
            body: JSON.stringify(data),
        }),
...
export const adminAsmaulHusnaApi = {
    ...
    update: (id, data) =>
        authFetch(`/api/v1/asmaul-husna/${id}`, {
            method: "PUT",
            body: JSON.stringify(data),
        }),
    delete: (id) =>
        authFetch(`/api/v1/asmaul-husna/${id}`, { method: "DELETE" }),
};

export const adminKajianApi = {
    list: (page = 0, size = 100) =>
        authFetch(`/api/v1/kajian?page=${page}&size=${size}`),
    create: (data) =>
        authFetch("/api/v1/kajian", {
            method: "POST",
            body: JSON.stringify(data),
        }),
    update: (id, data) =>
        authFetch(`/api/v1/kajian/${id}`, {
            method: "PUT",
            body: JSON.stringify(data),
        }),
...
export const adminLibraryApi = {
    list: (page = 0, size = 100) =>
        authFetch(`/api/v1/library/admin/books?page=${page}&size=${size}`),
    create: (data) =>
        authFetch("/api/v1/library/books", {
            method: "POST",
            body: JSON.stringify(data),
        }),
    update: (id, data) =>
        authFetch(`/api/v1/library/books/${id}`, {
            method: "PUT",
            body: JSON.stringify(data),
        }),
    uploadResource: (id, file) => {
        ...
        return authFetch(`/api/v1/library/books/${id}/resource`, {
            method: "POST",
            body: data,
        });
    },
...
export const adminKamusApi = {
    ...
    create: (data) =>
        authFetch("/api/v1/dictionary", {
            method: "POST",
            body: JSON.stringify(data),
        }),
    update: (id, data) =>
        authFetch(`/api/v1/dictionary/${id}`, {
            method: "PUT",
            body: JSON.stringify(data),
        }),
...
export const adminQuizApi = {
    list: (page = 0, size = 100) =>
        authFetch(`/api/v1/quiz/questions/all?page=${page}&size=${size}`),
    create: (data) =>
        authFetch("/api/v1/quiz/questions", {
            method: "POST",
            body: JSON.stringify(data),
        }),
    update: (id, data) =>
        authFetch(`/api/v1/quiz/questions/${id}`, {
            method: "PUT",
            body: JSON.stringify(data),
        }),
    delete: (id) =>
...
export const adminAsbabunNuzulApi = {
    list: (page = 0, size = 100) =>
        authFetch(`/api/v1/asbabun-nuzul?page=${page}&size=${size}`),
    create: (data) =>
        authFetch("/api/v1/asbabun-nuzul", {
            method: "POST",
            body: JSON.stringify(data),
        }),
    update: (id, data) =>
        authFetch(`/api/v1/asbabun-nuzul/${id}`, {
            method: "PUT",
            body: JSON.stringify(data),
        }),
    delete: (id) =>
        authFetch(`/api/v1/asbabun-nuzul/${id}`, { method: "DELETE" }),
};

export const adminWiridApi = {
    list: (page = 0, size = 100) =>
        authFetch(`/api/v1/wirid?page=${page}&size=${size}`),
    create: (data) =>
        authFetch("/api/v1/wirid", {
            method: "POST",
            body: JSON.stringify(data),
        }),
    update: (id, data) =>
        authFetch(`/api/v1/wirid/${id}`, {
            method: "PUT",
            body: JSON.stringify(data),
        }),
...
export const adminManasikApi = {
    ...
    create: (data) =>
        authFetch("/api/v1/manasik", {
            method: "POST",
            body: JSON.stringify(data),
        }),
    update: (id, data) =>
        authFetch(`/api/v1/manasik/${id}`, {
            method: "PUT",
            body: JSON.stringify(data),
        }),
...
export const adminFiqhApi = {
    list: (page = 0, size = 100) =>
        authFetch(`/api/v1/fiqh/items?page=${page}&size=${size}`),
    create: (data) =>
        authFetch("/api/v1/fiqh/items", {
            method: "POST",
            body: JSON.stringify(data),
        }),
    update: (id, data) =>
        authFetch(`/api/v1/fiqh/items/${id}`, {
            method: "PUT",
            body: JSON.stringify(data),
        }),
...
export const quranApi = {
    bySurahPage: (surahNumber, page = 0, size = 300) =>
        fetch(
            `${API_URL}/api/v1/ayah/surah/number/${surahNumber}?page=${page}&size=${size}`,
        ),
...
export const kalkulasiZakatApi = {
    save: (data) =>
        authFetch("/api/v1/zakat/kalkulasi", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify(data),
        }),
    ...
    delete: (id) =>
        authFetch(`/api/v1/zakat/kalkulasi/${id}`, { method: "DELETE" }),
};

export const faraidhSimpanApi = {
    save: (data) =>
        authFetch("/api/v1/faraidh/simpan", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify(data),
        }),
    ...
    delete: (id) =>
        authFetch(`/api/v1/faraidh/simpan/${id}`, { method: "DELETE" }),
};
...
export const forumApi = {
    ...
    create: (data) =>
        authFetch("/api/v1/forum/questions", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify(data),
        }),
    delete: (id) =>
        authFetch(`/api/v1/forum/questions/${id}`, { method: "DELETE" }),
    answer: (questionId, data) =>
        authFetch(`/api/v1/forum/questions/${questionId}/answers`, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify(data),
        }),
    ...
    deleteAnswer: (id) =>
        authFetch(`/api/v1/forum/answers/${id}`, { method: "DELETE" }),
    vote: (data) =>
        authFetch("/api/v1/forum/votes", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify(data),
        }),
...
export const feedApi = {
    ...
    report: (id, data) =>
        authFetch(`/api/v1/feed/${id}/report`, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify(data || {}),
        }),
...
export const notificationInboxApi = {
    ...
    markRead: (id) =>
        authFetch(`/api/v1/notifications/inbox/${id}/read`, { method: "PUT" }),
    markAllRead: () =>
        authFetch("/api/v1/notifications/inbox/read-all", { method: "PUT" }),
    delete: (id) =>
        authFetch(`/api/v1/notifications/inbox/${id}`, { method: "DELETE" }),
};
