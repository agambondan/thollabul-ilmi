...
export const readStoredThemePreference = async () => normalizeThemePreference(
...
export function LayoutModeProvider({ children }) {
  ...
  const [themePreference, setThemePreferenceState] = useState(defaultThemePreference);
  ...
  const resolvedTheme = themePreference === appThemes.system
    ? (systemColorScheme === appThemes.dark ? appThemes.dark : appThemes.light)
    : themePreference;
