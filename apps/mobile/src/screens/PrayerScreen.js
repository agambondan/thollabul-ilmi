...
const WEB_APP_PRAYER_THEMES = {
    light: {
        accent: WEB_APP_PRAYER_ACCENT,
        accentSoft: WEB_APP_PRAYER_ACCENT_SOFT,
        bg: WEB_APP_PRAYER_BG,
        border: WEB_APP_PRAYER_BORDER,
        input: "#f8fafc",
        line: "#f1f5f9",
        messageBg: "#fff7ed",
        messageBorder: "#fed7aa",
        messageText: "#c2410c",
        muted: WEB_APP_PRAYER_MUTED,
        surface: WEB_APP_PRAYER_SURFACE,
        text: WEB_APP_PRAYER_TEXT,
        title: "#065f46",
    },
    dark: {
        accent: "#34d399",
...
export function PrayerScreen({ isActive, navigation }) {
    ...
    const getPrayerLabel = (key) =>
        translatedPrayerLabels[key] ?? t("prayer.name.generic");
    const formatDays = (days) => t("prayer.meta.days", { days });
    const formatReminderLead = (minutes) =>
        minutes
            ? t("prayer.meta.minutes", { minutes })
            : t("prayer.reminder.atTime");

    useEffect(() => {
        setOfflineMessage((current) =>
            current === defaultOfflineMessageRef.current
    ...
    const toggleReminderPrayer = async (key) => {
        ...
        const next = exists
            ? reminderPrayers.filter((item) => item !== key)
            : [...reminderPrayers, key];
    ...
    const downloadPrayerPack = async () => {
        ...
        try {
            ...
            setPrayerOffline(overview);
            setOfflineMessage(
                t("prayer.offline.saved", { days: overview.days }),
            );
    ...
    const clearPrayerPack = async () => {
        ...
        setOfflineBusy(true);
        try {
            const overview = await clearPrayerOfflinePack({
                ...coords,
                method,
                madhab,
            });
            ...
            const nextMessage =
                error?.message ?? t("prayer.offline.clearError");
            setOfflineMessage(nextMessage);
            showError(nextMessage);
        } finally {
            setOfflineBusy(false);
    ...
    const renderManualLocationCard = (webApp = false) => (
        <Card style={webApp ? [styles.webAppCard, webCardStyle] : null}>
            <CardTitle
                ...
                metaStyle={
                    webApp
                        ? [styles.webAppCardMeta, { color: webTheme.accent }]
                        : null
                }
                titleStyle={
                    webApp
                        ? [styles.webAppCardTitle, { color: webTheme.text }]
                        : null
                }
            >
            ...
            <View
                style={[
                    styles.manualLocRow,
                    webApp ? styles.webAppManualLocRow : null,
                ]}
            >
                <TextInput
            ...
            <Pressable
                ...
                style={[
                    styles.button,
                    webApp ? styles.webAppPrimaryButton : null,
                    webApp ? { backgroundColor: webTheme.accent } : null,
                    !manualLatInput || !manualLngInput ? styles.disabled : null,
                ]}
            >
                <Text style={styles.buttonText}>
                    {t("prayer.manual.apply")}
                </Text>
            </Pressable>
        </Card>
    );
            ...
            return (
                <Screen
                    ...
                    actions={
                        <IconActionButton
                            Icon={ArrowLeft}
                            label={t("prayer.action.backSchedule")}
                ...
                >
                    <View
                        ...
                        testID='prayer-web-app-settings'
                    />
                    {message ? (
                        <Text
                            style={[
                                ...
                                {
                                    backgroundColor: webTheme.messageBg,
                                    borderColor: webTheme.messageBorder,
                    ...
                    <View
                        style={[styles.webAppSettingsHero, webCardStyle]}
                        testID='prayer-web-app-settings-hero'
                    >
                        <Text
                            style={[
                        ...
                        >
                            {t("prayer.title").toUpperCase()}
                        </Text>
                        <Text
                            style={[
                                styles.webAppHeroTitle,
                                { color: webTheme.text },
                            ]}
                        >
                            {t("prayer.settings.shortTitle")}
                        </Text>
                        <Text
                            style={[
                                styles.webAppHeroMeta,
                    ...
                    <Card style={[styles.webAppCard, webCardStyle]}>
                        ...
                        >
                            {t("prayer.adjustments.description")}
                        </Text>
                        {translatedScheduleRows.map(([key, label]) => (
                            <View
                                key={key}
                                style={[
                                    styles.webAppCorrectionRow,
                        ...
                        <CardTitle
                            meta={
                                prayerOffline?.supported === false
                                    ? t("prayer.meta.mobileApp")
                                    : formatDays(prayerOffline?.days ?? 0)
                            }
                            metaStyle={[
                                styles.webAppCardMeta,
                                { color: webTheme.accent },
                        ...
                        <View style={styles.webAppProgressTrack}>
                            <View
                                style={[
                                    ...
                                    {
                                        width: `${Math.min(offlineProgress, 100)}%`,
                                    },
                                ]}
                            />
                        </View>
                        ...
                        <View style={styles.offlineActions}>
                            <Pressable
                                ...
                                style={[
                                    ...
                                    styles.webAppOfflinePrimaryButton,
                                    offlineBusy ||
                                    prayerOffline?.supported === false
                                        ? styles.disabled
                                        : null,
                            ...
                            >
                                {offlineBusy ? (
                                    ...
                                    <Text style={styles.offlinePrimaryText}>
                                        {t("prayer.offline.save30")}
                                    </Text>
                                )}
                            </Pressable>
                            <Pressable
        ...
        return (
            ...
            >
                <View
                    testID={
                        isWebAppLayout
                            ? "prayer-web-app-settings"
                            : "prayer-classic-settings"
                    }
                />
                {message ? <Text style={styles.message}>{message}</Text> : null}

                <Card>
                    <CardTitle meta={t("prayer.method.meta")}>
                        {t("prayer.method.title")}
                    </CardTitle>
                ...
                <Card>
                    <CardTitle meta={t("prayer.adjustments.meta")}>
                        {t("prayer.adjustments.title")}
                    </CardTitle>
        ...
        return (
            <Screen
                ...
                actions={
                    <>
                        <IconActionButton
                            Icon={RefreshCw}
                            label={t("prayer.action.refreshSchedule")}
                            onPress={refreshAll}
                            disabled={loading}
                        />
                        <IconActionButton
                            Icon={Settings}
                            label={t("prayer.action.openSettings")}
            ...
            >
                ...
                <View style={styles.webAppHero}>
                    <View
                        style={[
                            styles.webAppHeroIcon,
                            { backgroundColor: webTheme.accentSoft },
                        ]}
                    >
                        <Text
                            style={[
                                styles.webAppHeroIconText,
                                { color: webTheme.accent },
                            ]}
                        >
                            وقت
                ...
                <View style={styles.webAppClockPanel}>
                    <Text
                        style={[
                            styles.webAppClockTime,
                            { color: webTheme.title },
                        ]}
                    >
                        {currentTimeLabel}
                    </Text>
                    {prayers && countdown !== null ? (
                        <View style={styles.webAppCountdownRow}>
                            <Text
                                style={[
                                    styles.webAppCountdownLabel,
                                    { color: webTheme.muted },
                                ]}
                            >
                                {countdown === 0
                                    ? t("prayer.countdown.arrived", {
                                          prayer: getPrayerLabel(nextPrayerKey),
                                      })
                                    : t("prayer.countdown.towards", {
                            ...
                            <Text
                                style={[
                                    styles.webAppCountdownTime,
                                    { color: webTheme.accent },
                                ]}
                            >
                                {countdown === 0
                                    ? t("prayer.countdown.now")
                            ...
                            {adzanPlaying ? (
                                ...
                                >
                                    ...
                                    <Text style={styles.webAppAdzanStopText}>
                                        {t("prayer.action.stop")}
                                    </Text>
                                </Pressable>
                            ) : null}
                        </View>
                        ...
                        >
                            {t("prayer.schedule.loadingContext")}
                        </Text>
                    )}
                </View>

                <View
                    style={[styles.webAppScheduleCard, webCardStyle]}
                    testID='prayer-web-app-schedule-card'
                >
                    <View
                        style={[
                            styles.webAppScheduleHeader,
                            { borderBottomColor: webTheme.line },
                        ]}
                    >
                        <Text
                            style={[
                                styles.webAppScheduleTitle,
                                { color: webTheme.text },
                            ]}
                        >
                            {t("prayer.today")}
                    ...
                    {loading && !prayers ? (
                        ...
                        translatedScheduleRows.map(([key, label], index) => {
                            ...
                            const isNext =
                                ...
                                key !== "sunrise";
                            const isCurrent =
                                key === currentPrayerKey && !nextPrayerKey;
                                ...
                                <View
                                    ...
                                    style={[
                                        ...
                                        index === scheduleRows.length - 1
                                            ? styles.webAppPrayerRowLast
                                            : null,
                                        isNext || isCurrent
                                            ? styles.webAppPrayerRowActive
                                            : null,
                                        isInfo
                                            ? styles.webAppPrayerRowInfo
                                            : null,
                                    ]}
                                >
                                    <View style={styles.webAppPrayerCopy}>
                                        <View
                                            style={styles.webAppPrayerLabelRow}
                                        >
                                            {isNext ? (
                                                <Text
                                                    style={
                                                        styles.webAppNextBadge
                                                    }
                                                >
                                                    {t("prayer.nextBadge")}
                                                </Text>
                                            ...
                                            <Text
                                                style={[
                                                    ...
                                                    { color: webTheme.text },
                                                    isNext || isCurrent
                                                        ? styles.webAppPrayerLabelActive
                                                        : null,
                                                ]}
                                            >
                                                {label}
                                        ...
                                        <Text
                                            style={[
                                                styles.webAppPrayerArabic,
                                                { color: webTheme.muted },
                                                isNext || isCurrent
                                                    ? styles.webAppPrayerArabicActive
                                                    : null,
                                            ]}
                                        >
                                    ...
                                    <View style={styles.webAppPrayerTimeBlock}>
                                        <Text
                                            style={[
                                                styles.webAppPrayerTime,
                                                { color: webTheme.accent },
                                                isNext || isCurrent
                                                    ? styles.webAppPrayerTimeActive
                                                    : null,
                                            ]}
                                        >
                                        ...
                                        {adjustment ? (
                                            <Text
                                                style={[
                                                    styles.webAppPrayerAdjustment,
                                                    { color: webTheme.muted },
                                                    isNext || isCurrent
                                                        ? styles.webAppPrayerAdjustmentActive
                                                        : null,
                                                ]}
                                            >
                                                {adjustment > 0 ? "+" : ""}
                ...
                <Text
                    style={[styles.webAppSourceNote, { color: webTheme.muted }]}
                >
                    {t("prayer.sourceNote", {
                        method: methodLabel,
                        madhab: madhabLabel,
