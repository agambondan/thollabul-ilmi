...
export const createQuranWebAppThemeStyles = (theme) => StyleSheet.create({
    ...
    readerHeader: { backgroundColor: theme.surface, borderColor: theme.border },
    ...
    surahPagerButton: { backgroundColor: theme.surface, borderColor: theme.border },
    ...
    quranSearch: { backgroundColor: theme.surface, borderColor: theme.searchBorder },
    quranSearchInput: { color: theme.input },
    mushafCta: { backgroundColor: theme.readerBg, borderColor: theme.ctaBorder },
