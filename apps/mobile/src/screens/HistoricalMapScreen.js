...
const getLocationName = (loc, fallback = "Lokasi") =>
    String(loc?.name ?? loc?.title ?? fallback);
const getLocationDescription = (loc) =>
    String(loc?.description ?? loc?.summary ?? "");
...
export function HistoricalMapContent() {
    ...
    const webAppTheme = isDarkTheme
        ...
        : WEB_APP_HISTORICAL_MAP_THEMES.light;
                    ...
                    >
                        <Text
                            style={[
                                styles.chipText,
                                isWebAppLayout && { color: webAppTheme.muted },
                                era === item.value && styles.chipTextActive,
                            ]}
                        >
                            {item.label}
                        </Text>
    ...
    const renderSearch = () => (
        <TextInput
            ...
            testID={
                isWebAppLayout ? "historical-map-web-app-search" : undefined
            }
            value={search}
        />
    );
            ...
            {loading ? (
                ...
                >
                    <ActivityIndicator
                        size='large'
                        color={
                            isWebAppLayout ? webAppTheme.accent : colors.primary
                        }
                    />
                    {isWebAppLayout ? (
                        <Text
                        ...
                        >
                            {t("historicalMap.loadingLocations")}
                        </Text>
                    ) : null}
                </View>
            ) : viewMode === "map" ? (
    ...
    if (isWebAppLayout) {
        return (
            <View
                ...
                testID='historical-map-web-app-surface'
            >
                ...
                <View style={styles.webAppControls}>
                    ...
                    <View style={styles.webAppMetaRow}>
                        <Text
                            style={[
                                styles.webAppMetaText,
                                { color: webAppTheme.muted },
                            ]}
                        >
                            {loading
                                ? t("historicalMap.loadingShort")
                                : t("historicalMap.locationsCount", {
