...
function BlogCard({
  ...
  const publishedAt = formatDate(raw.published_at ?? raw.publishedAt ?? raw.created_at);
  const cover = [raw.cover_image, raw.coverImage, raw.image_url, raw.image]
      ...
      <View style={styles.body}>
        ...
        {author || publishedAt ? (
          <View style={styles.metaRow}>
            {author ? <Text numberOfLines={1} style={styles.meta}>{author}</Text> : <View />}
      ...
      {categories.length ? (
        <View style={styles.categories}>
          <Pressable
            ...
            style={[styles.categoryPill, !blogCategory && styles.categoryPillActive]}
          ...
          {categories.map((category) => (
            <Pressable
              ...
              style={[
                styles.categoryPill,
                blogCategory.toLowerCase() === category.value.toLowerCase() && styles.categoryPillActive,
              ]}
            ...
            >
              <Text
                style={[
                  ...
                  blogCategory.toLowerCase() === category.value.toLowerCase() && styles.categoryPillTextActive,
                ]}
              >
                {category.label}
              </Text>
