...
export const createExploreWebAppThemeStyles = (theme) => StyleSheet.create({
  ...
  pinButton: { backgroundColor: theme.surface, borderColor: theme.border },
  pinButtonActive: { backgroundColor: theme.active, borderColor: theme.accent },
