...
import {
    WEB_APP_REFERENCE_ROUTE_CONFIGS,
    WebAppReferenceListRoute,
} from "./WebAppReferenceListRoute";
            ...
            >
                ...
                <View style={styles.webAppBookmarkBody}>
                    <View style={styles.webAppBookmarkHeader}>
                        ...
                        <Text style={styles.webAppBookmarkRef}>
                            {refId ? `#${refId}` : "Tersimpan"}
                        </Text>
                    </View>
                    ...
                    {raw.ref_slug ? (
                        <Text
                            numberOfLines={1}
                            style={styles.webAppBookmarkSlug}
                        >
                            {raw.ref_slug}
                        </Text>
                    ) : null}
...
const renderWebAppBookmarksScreen = () => {
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    >
                        Ayat, hadith, dan referensi yang kamu simpan dari
                        dashboard belajar.
                    </Text>
                </View>
                    ...
                    <View style={styles.webAppBookmarksGroups}>
                        {Object.entries(groupedBookmarks).map(
                            ([type, groupItems]) => (
                                <View
                                    key={type}
                                    style={styles.webAppBookmarksGroup}
                                >
                                    <View
                                        style={[
                                            styles.webAppBookmarksGroupHeader,
                                            webAppExploreThemeStyles.groupHeader,
                                        ]}
                                    >
                                        <Text
                                            style={[
                                                styles.webAppBookmarksGroupTitle,
                                                webAppExploreThemeStyles.groupTitle,
                                            ]}
                                        >
                                        ...
                                        <Text
                                            style={[
                                                styles.webAppBookmarksGroupCount,
                                                webAppExploreThemeStyles.groupCount,
                                            ]}
                                        >
                                            {groupItems.length}
                                        </Text>
    ...
    const renderWebAppNoteCard = (item, index) => {
        ...
        const date = formatNoteDate(
            item?.raw?.date ?? item?.raw?.created_at ?? item?.date,
        );
            ...
            >
                ...
                <View style={styles.webAppNoteBody}>
                    <View style={styles.webAppBookmarkHeader}>
                        ...
                        {date ? (
                            <Text style={styles.webAppBookmarkRef}>{date}</Text>
                        ) : null}
                    </View>
                    <Text numberOfLines={2} style={styles.webAppBookmarkTitle}>
    ...
    const renderWebAppNotesScreen = () => {
        ...
        const filteredNotes = normalizedQuery
            ? visibleItems.filter((item) =>
                  [item.title, item.body, item.meta, ...getNoteTags(item)].some(
                      (value) =>
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    >
                        Ringkasan tadabbur, kajian, dan refleksi pribadi dalam
                        tampilan dashboard.
                    </Text>
                </View>
                ...
                <View
                    style={[
                        styles.webAppNotesSearch,
                        webAppExploreThemeStyles.search,
                    ]}
                >
                    <TextInput
                ...
                {!loading && !error && !items.length ? (
                    ...
                    >
                        ...
                        >
                            Buka detail konten untuk menambahkan catatan
                            pertama.
                        </Text>
                    </View>
                ) : null}
    ...
    const renderWebAppGoalCard = (item, index) => {
        ...
        return (
            <Pressable
                ...
                onLongPress={() => setItemActionSheet({ visible: true, item })}
                onPress={() => openItemDetail(item)}
                style={[styles.webAppGoalCard, webAppExploreThemeStyles.card]}
                testID='web-app-goal-card'
            >
                <View
                    style={[
                        styles.webAppGoalHeader,
                        webAppExploreThemeStyles.groupHeader,
                    ]}
                >
                    <View
                    ...
                    <Text
                        style={[
                            styles.webAppGoalStatus,
                            completed && styles.webAppGoalStatusDone,
                        ]}
                    >
                        {statusLabel}
                    </Text>
    ...
    const renderWebAppGoalsScreen = () => {
        const activeGoals = visibleItems.filter(
            (item) => !getGoalCompleted(item),
        ).length;
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    >
                        Target hafalan, kajian, dan rutinitas ilmu dalam
                        tampilan dashboard.
                    </Text>
                </View>
                ...
                {!loading && !error && !items.length ? (
                    ...
                    >
                        ...
                        >
                            Buat target belajar dari dashboard web atau fitur
    ...
    const renderWebAppMuhasabahCard = (item, index) => {
        ...
        return (
            ...
            >
                <View
                    style={[
                        styles.webAppMuhasabahHeader,
                        webAppExploreThemeStyles.groupHeader,
                    ]}
                >
                    <View
                        style={[
                            styles.webAppNoteIcon,
                            webAppExploreThemeStyles.iconBox,
                        ]}
                    >
                        <Pencil
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    >
                        Jurnal refleksi harian untuk menjaga arah belajar dan
                        ibadah.
                    </Text>
                </View>
                ...
                {!loading && !error && !items.length ? (
                    ...
                    >
                        ...
                        >
                            Tulis refleksi dari dashboard web atau lanjutkan
                            saat sudah login.
                        </Text>
                    </View>
                ) : null}
    ...
    const renderWebAppHafalanScreen = () => {
        ...
        const progress =
            summary.total > 0
                ? Math.round((summary.memorized / summary.total) * 100)
                : 0;
                            ...
                            <View style={styles.webAppStatsChart}>
                                {prayerRows.map((row, index) => {
                                    ...
                                    return (
                                        <View
                                            key={`${row.date}-${index}`}
                                            style={styles.webAppStatsBarColumn}
                                            ...
                                            >
                                                <View
                                                    style={[
                                                        ...
                                                        row.count >= 5 &&
                                                            styles.webAppStatsBarFillDone,
                                                        row.count > 0 &&
                                                            row.count < 5 &&
                                                            styles.webAppStatsBarFillPartial,
                                                        { height },
                                                    ]}
                                                />
                                            </View>
    ...
    if (!activeFeature) {
        return (
            <ScrollView
                contentContainerStyle={[
                    styles.webAppCatalogContent,
                    webAppExploreThemeStyles.content,
                ]}
                keyboardShouldPersistTaps='handled'
                showsVerticalScrollIndicator={false}
                style={[
                    styles.webAppCatalogRoot,
                    webAppExploreThemeStyles.root,
                ]}
    ...
    if (activeFeature?.key === "kajian") {
        const filteredKajian = getFilteredKajianItems(
            visibleItems,
            kajianSearch,
            kajianCategory,
        );
    ...
    if (activeFeature?.key === "fiqh") {
        return (
            <WebAppFiqhRoute
                ...
                onOpenItem={openItemDetail}
                pagination={pagination}
                webAppExploreThemeStyles={webAppExploreThemeStyles}
            />
        );
    }
