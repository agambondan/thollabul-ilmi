...
function IbadahHub({ navigation, onOpenTab }) {
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    <Text
                        style={[styles.webAppTitle, { color: webTheme.title }]}
                    >
                        {t("ibadah.title")}
                    </Text>
                    <Text
                                        ...
                                        style={[
                                            styles.webAppTile,
                                            {
                                                backgroundColor: primary
                                                    ? webTheme.primaryTile
                                                    : webTheme.tile,
                                                borderColor: primary
                                                    ? webTheme.primaryTileBorder
                                                    : webTheme.border,
                                            },
                                        ]}
    ...
    return (
        ...
        >
            <View
                testID={
                    isWebAppLayout ? "ibadah-web-app-hub" : "ibadah-classic-hub"
                }
            />
            {sections.map((section) => (
    ...
    if (view === "qibla") {
        return (
            <QiblaScreen
                ...
                onBack={() => navigation?.close?.("ibadah")}
                onOpenTab={onOpenTab}
            />
        );
    }
