...
export function KhatamScreen({ isActive, navigation, onOpenTab }) {
    ...
    if (isWebAppLayout) {
        return (
            ...
            >
                <View
                    style={{ backgroundColor: webAppTheme.bg }}
                    testID='khatam-web-app-surface'
                />
                {!user ? (
                    <View
                        style={[
                            styles.webAppGuestCard,
                            {
                    ...
                    <>
                        ...
                        <View style={styles.webAppHeroCard}>
                            <View style={styles.webAppHeroTop}>
                                <View>
                                    <Text style={styles.webAppHeroLabel}>
                                        {t("khatam.hero.current")}
                                    </Text>
                                    <Text style={styles.webAppHeroValue}>
                                        {stats.pct.toFixed(1)}%
                                    </Text>
                                </View>
                                <View style={styles.webAppHeroRight}>
                                    <Text style={styles.webAppHeroLabel}>
                                        {t("khatam.hero.lastRead")}
                                    </Text>
                                    <Text style={styles.webAppHeroSurah}>
                                        QS. {progress.surahNumber}:
                                        {progress.ayahNumber}
                                    </Text>
                                </View>
                            </View>
                            ...
                            <View style={styles.webAppHeroFoot}>
                                <Text style={styles.webAppHeroFootText}>
                                    {t("khatam.hero.ayahProgress", {
                                        current: stats.currentIdx,
                                        total: TOTAL_AYAH,
                                    })}
                                </Text>
                                <Text style={styles.webAppHeroFootText}>
                                    {t("khatam.hero.remaining", {
                                        count: stats.target.ayahsLeft,
                                    })}
                                </Text>
                            </View>
                        ...
                        >
                                        ...
                                        >
                                            <Text
                                                style={[
                                                    ...
                                                    selected
                                                        ? styles.webAppTargetChipTextActive
                                                        : null,
                                                ]}
                                            >
                                                {option.label}
                            ...
                            <View style={styles.webAppTargetGrid}>
                                <View
                                    style={[
                                        styles.webAppTargetStat,
                                        styles.webAppTargetStatGreen,
                                        {
                                            backgroundColor:
                                                webAppTheme.accentSoft,
                                        },
                                ...
                                >
                                    <Text
                                        style={[
                                            styles.webAppTargetValue,
                                            { color: webAppTheme.accent },
                                        ]}
                                    >
                                        {stats.target.daysLeft}
                                    </Text>
                                    <Text
                                        style={[
                                            styles.webAppTargetLabel,
                                            { color: webAppTheme.muted },
                                        ]}
                                    >
                                        {t("khatam.target.daysLeft")}
                                    </Text>
                                </View>
                                <View
                                    style={[
                                        styles.webAppTargetStat,
                                        styles.webAppTargetStatAmber,
                                        {
                                            backgroundColor:
                                                webAppTheme.amberSoft,
                                        },
                                    ]}
                                >
                                    <Text
                                        style={[
                                            styles.webAppTargetValue,
                                            styles.webAppTargetValueAmber,
                                            { color: webAppTheme.amber },
                                        ]}
                                    >
                                    ...
                                    >
                                        {t("khatam.target.ayahsPerDay")}
                                    </Text>
                                </View>
                                <View
                                    style={[
                                        styles.webAppTargetStat,
                                        styles.webAppTargetStatBlue,
                                        {
                                            backgroundColor:
                                                webAppTheme.blueSoft,
                                        },
                                    ]}
                                >
                                    <Text
                                        style={[
                                            styles.webAppTargetValue,
                                            styles.webAppTargetValueBlue,
                                            { color: webAppTheme.blue },
                                        ]}
                                    >
                                        {Math.ceil(
                                            stats.target.ayahsPerDay / 15,
                                        )}
                                    </Text>
                                    <Text
                                        style={[
                        ...
                        >
                                    ...
                                    return (
                                        <View
                                            ...
                                            style={[
                                                ...
                                                item.pct >= 100
                                                    ? styles.webAppJuzCellDone
                                                    : null,
                                                partial
                                                    ? styles.webAppJuzCellPartial
                                                    : null,
                                                item.isCurrent
                                                    ? styles.webAppJuzCellCurrent
                                                    : null,
                                            ]}
                                        >
                                            <Text
                                                style={[
                                                    ...
                                                    item.pct >= 100
                                                        ? styles.webAppJuzTextDone
                                                        : null,
                                                    partial
                                                        ? styles.webAppJuzTextPartial
                                                        : null,
                                                ]}
                                            >
                                                {item.juz}
                            ...
                            >
                                <Text style={styles.webAppPrimaryButtonText}>
                                    {t("khatam.action.continueReading")}
                                </Text>
                            </Pressable>
                        </View>
                    </>
    ...
    return (
        <Screen
            ...
            actions={
                <>
                    <IconActionButton
                        Icon={ArrowLeft}
                        label={t("khatam.action.backIbadah")}
                        onPress={() => navigation?.close?.("ibadah")}
                    />
                    <IconActionButton
                        Icon={RefreshCw}
                        label={t("khatam.action.refresh")}
        ...
        >
            <View
                testID={
                    isWebAppLayout
                        ? "khatam-web-app-surface"
                        : "khatam-classic-surface"
                }
            />
            {!user ? (
                <EmptyState
            ...
            {progress && stats ? (
                <>
                    ...
                    <Card>
                        <CardTitle meta={t("khatam.target.defaultMeta")}>
                            {t("khatam.target.title")}
                        </CardTitle>
                    ...
                    <Card>
                        <CardTitle meta={t("khatam.juz.meta")}>
                            {t("khatam.juz.title")}
                        </CardTitle>
