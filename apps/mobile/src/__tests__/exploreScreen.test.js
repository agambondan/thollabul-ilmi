    ...
    const belajarFeatureGroups = [
        {
            ...
            features: allFeatures.filter((f) =>
                ["community-feed", "kajian", "blog", "forum"].includes(f.key),
            ),
        },
        {
            key: "referensi",
...
describe("ExploreScreen", () => {
    ...
    test("uses dashboard Zakat history child surface in web app layout", async () => {
        ...
        await waitFor(() =>
            expect(
                queryByTestId("explore-web-app-zakat-history-surface"),
            ).toBeNull(),
        );
    });
    ...
    test("uses dashboard Bookmark route surface in web app layout", async () => {
        ...
        const { getAllByText, getByTestId, getByText, queryByTestId } =
            await renderExploreScreen({
                deepLinkTarget: {
                    id: "bookmarks-route",
                    params: { featureKey: "bookmarks" },
                },
            });

        await waitFor(() => {
            expect(
                getByTestId("explore-web-app-bookmarks-surface"),
            ).toBeTruthy();
            expect(queryByTestId("screen-title")).toBeNull();
        ...
        const { getByTestId, getByText, queryByTestId } =
            await renderExploreScreen({
                deepLinkTarget: {
                    ...
                    params: { featureKey: "notifications" },
                },
            });

        await waitFor(() => {
            expect(
                getByTestId("explore-web-app-notifications-surface"),
            ).toBeTruthy();
            expect(queryByTestId("screen-title")).toBeNull();
            expect(getByText("PERSONAL")).toBeTruthy();
    ...
    test("uses dashboard Goals route surface in web app layout", async () => {
        ...
        await waitFor(() => {
            ...
            expect(getAllByTestId("web-app-goal-progress-fill")).toHaveLength(
                2,
            );
        });
    ...
    test("uses dashboard Muhasabah route surface in web app layout", async () => {
        ...
        const { getAllByTestId, getByText, getByTestId, queryByTestId } =
            await renderExploreScreen({
                deepLinkTarget: {
                    id: "muhasabah-route",
                    params: { featureKey: "muhasabah" },
                },
            });

        await waitFor(() => {
            expect(
                getByTestId("explore-web-app-muhasabah-surface"),
            ).toBeTruthy();
            expect(queryByTestId("screen-title")).toBeNull();
            expect(getByText("PERSONAL")).toBeTruthy();
            ...
            expect(
                getByText("Menjaga niat belajar dan memperbaiki adab."),
            ).toBeTruthy();
    ...
    test("uses dashboard Hafalan route surface in web app layout", async () => {
        ...
        await waitFor(() => {
            ...
            expect(
                getAllByTestId("web-app-hafalan-progress-fill"),
            ).toHaveLength(3);
        });
    ...
    test("uses dashboard Murojaah route surface in web app layout", async () => {
        ...
        await waitFor(() => {
            expect(
                getByTestId("explore-web-app-murojaah-surface"),
            ).toBeTruthy();
            expect(queryByTestId("screen-title")).toBeNull();
            expect(getByText("PROGRESS SAYA")).toBeTruthy();
    ...
    test("uses dashboard Leaderboard route surface in web app layout", async () => {
                ...
                items: [
                    {
                        id: "streak-1",
                        title: "Ahmad",
                        raw: { name: "Ahmad", rank: 1, score: 21 },
                    },
                    {
                        id: "streak-2",
                        title: "Fatimah",
                        raw: { name: "Fatimah", rank: 2, score: 18 },
                    },
                ],
                meta: { hasMore: false },
            })
                ...
                items: [
                    {
                        id: "hafalan-1",
                        title: "Zaid",
                        raw: { name: "Zaid", rank: 1, score: 30 },
                    },
                    {
                        id: "hafalan-2",
                        title: "Maryam",
                        raw: { name: "Maryam", rank: 2, score: 24 },
                    },
                    {
                        id: "hafalan-3",
                        title: "Umar",
                        raw: { name: "Umar", rank: 3, score: 20 },
                    },
                ],
                meta: { hasMore: false },
            });
        ...
        const {
            ...
            deepLinkTarget: {
                ...
                params: { featureKey: "leaderboard" },
            },
        });

        await waitFor(() => {
            expect(
                getByTestId("explore-web-app-leaderboard-surface"),
            ).toBeTruthy();
            expect(queryByTestId("screen-title")).toBeNull();
            ...
            items: [
                {
                    ...
                    raw: {
                        audio_url: "https://example.test/doa.mp3",
                        category: "bangun",
                ...
                },
                {
                    ...
                    arabic: "اللَّهُمَّ افْتَحْ لِي",
                    body: "Ya Allah bukakan untukku pintu rahmat-Mu.",
                    meta: "masjid",
                    raw: {
                        category: "masjid",
                        title: "Doa Masuk Masjid",
                        translation: {
                            ar: "اللَّهُمَّ افْتَحْ لِي",
                            idn: "Ya Allah bukakan untukku pintu rahmat-Mu.",
                        },
                    },
                },
            ],
    ...
    test("uses dashboard Kajian route surface in web app layout", async () => {
        ...
        await waitFor(() => {
            ...
            expect(
                getByText("Rekaman kajian dari ustadz-ustadz ahlus sunnah"),
            ).toBeTruthy();
        ...
        fireEvent.changeText(
            getByPlaceholderText("Cari kajian atau ustadz..."),
            "tafsir",
        );
    ...
    test("uses dashboard Blog route surface in web app layout", async () => {
        ...
        fireEvent.changeText(
            getByPlaceholderText("Cari artikel, penulis, atau kategori..."),
            "adab",
        );
    ...
    test("uses dashboard Library route surface in web app layout", async () => {
        ...
        await waitFor(() => {
            ...
            expect(getAllByText("Adab Penuntut Ilmu").length).toBeGreaterThan(
                0,
            );
            expect(getAllByText("Fiqh Ibadah Ringkas").length).toBeGreaterThan(
                0,
            );
        ...
        fireEvent.changeText(
            getByPlaceholderText("Cari judul, penulis, atau topik"),
            "adab",
        );
    ...
    test("uses dashboard Perawi route surface in web app layout", async () => {
        ...
        fireEvent.changeText(
            getByPlaceholderText("Cari nama perawi..."),
            "hurairah",
        );
            ...
            items: [
                {
                    ...
                    raw: {
                        category: "thaharah",
                        content:
                            "Membaca basmalah dan membasuh anggota wudhu dengan tertib.",
                ...
                },
                {
                    ...
                    raw: {
                        content:
                            "Zakat perdagangan dihitung dari modal dan barang dagangan.",
                        id: 2,
                        slug: "zakat",
    ...
    test("uses dashboard Siroh route surface in web app layout", async () => {
        ...
        await waitFor(() => {
            ...
            expect(
                getByText("Kisah perjalanan hidup Rasulullah Muhammad ﷺ"),
            ).toBeTruthy();
    ...
    test("uses dashboard Forum route surface in web app layout", async () => {
        ...
        const { getAllByTestId, getByTestId, getByText, queryByTestId } =
            await renderExploreScreen({
                deepLinkTarget: {
                    id: "forum-route",
                    params: { featureKey: "forum" },
                },
            });

        await waitFor(() => {
            expect(forumApi.getForumQuestions).toHaveBeenCalledWith({
                page: 0,
                size: 10,
            });
            ...
            expect(getAllByTestId("web-app-forum-question-card")).toHaveLength(
                1,
            );
        });
    ...
    test("uses dashboard Tafsir route surface in web app layout", async () => {
        ...
        await waitFor(() => {
            ...
            expect(
                getByText("Pilih surah untuk membaca penjelasan ayat."),
            ).toBeTruthy();
        ...
        await waitFor(() => {
            ...
            expect(getAllByTestId("web-app-tafsir-result-card")).toHaveLength(
                1,
            );
        });
    });
    ...
    test("uses dashboard Asbabun Nuzul route surface in web app layout", async () => {
        ...
        const {
            ...
            deepLinkTarget: {
                id: "asbabun-route",
                params: { featureKey: "asbabun-nuzul" },
            },
        });
        ...
        await waitFor(() => {
            ...
            expect(
                getByText("Masukkan nomor surah atau pilih contoh cepat."),
            ).toBeTruthy();
            expect(getAllByTestId("web-app-asbabun-quick-surah")).toHaveLength(
                7,
            );
        });
        ...
        await waitFor(() => {
            ...
            expect(exploreApi.getFeatureItemPage).toHaveBeenCalledWith(
                expect.objectContaining({
                    endpoint: "/api/v1/asbabun-nuzul/surah/1",
                }),
                { page: 0, size: 20 },
            );
            ...
            expect(getAllByTestId("web-app-asbabun-result-card")).toHaveLength(
                1,
            );
        });
    });
    ...
    test("uses a friendly Blog rate-limit message in web app layout", async () => {
        ...
        await waitFor(() => {
            ...
            expect(
                getByText(
                    "Artikel sedang terlalu sering dimuat. Coba lagi sebentar.",
                ),
            ).toBeTruthy();
        });
    ...
    test("opens Blog child detail in a web app dashboard detail surface", async () => {
        ...
        await waitFor(() => {
            ...
            expect(
                getByText("Ringkasan adab belajar dari para ulama."),
            ).toBeTruthy();
        });
    ...
    test("uses dashboard Feed route surface in web app layout", async () => {
        ...
        const {
            ...
            deepLinkTarget: {
                id: "feed-route",
                params: { featureKey: "community-feed" },
            },
        });
        ...
        await waitFor(() => {
            ...
            expect(
                getByText("Bagikan dan temukan konten dari pengguna lain"),
            ).toBeTruthy();
            expect(getByText("Login untuk membuat postingan.")).toBeTruthy();
            expect(getByText("Ustadz Ahmad")).toBeTruthy();
            expect(getByText("Tim Thullaabul")).toBeTruthy();
            expect(
                getByText("Faedah singkat tentang adab belajar."),
            ).toBeTruthy();
    ...
    test("renders section headers in catalog", async () => {
        ...
        expect(getAllByTestId("section-title").length).toBeGreaterThanOrEqual(
            1,
        );
    });
    ...
    test("feature items are tappable and load feature content", async () => {
        ...
        await waitFor(() => {
            expect(
                getByPlaceholderText("Cari kata Arab atau Indonesia"),
            ).toBeTruthy();
        });
    });
    ...
    test("forum detail supports question vote, answer downvote, and accept answer", async () => {
        ...
        forumApi.getForumQuestion.mockResolvedValue({
            answers: [
                {
                    id: "answer-1",
                    body: "Wajib jika mencapai nisab dan haul.",
                    voteCount: 3,
                    isAccepted: false,
                    user: { name: "Ustadz" },
                },
        ...
        await waitFor(() => {
            expect(
                getByText("Wajib jika mencapai nisab dan haul."),
            ).toBeTruthy();
        });

        fireEvent.press(getByText("▲ Pertanyaan"));
        await waitFor(() => {
            expect(forumApi.voteForum).toHaveBeenCalledWith({
                targetType: "question",
                targetId: "forum-1",
                value: 1,
            });
        ...
        await waitFor(() => {
            expect(forumApi.acceptForumAnswer).toHaveBeenCalledWith(
                "forum-1",
                "answer-1",
            );
        });
    ...
    test("forum ask form creates question and opens returned detail", async () => {
        ...
        forumApi.createForumQuestion.mockResolvedValueOnce({
            slug: "adab-belajar",
        });
        ...
        fireEvent.changeText(
            getByPlaceholderText("Judul pertanyaan (min 10 karakter)"),
            "Bagaimana adab belajar?",
        );
        fireEvent.changeText(
            getByPlaceholderText("Isi pertanyaan (min 20 karakter)"),
            "Apa saja adab belajar harian?",
        );
        fireEvent.changeText(
            getByPlaceholderText("Tag (pisahkan dengan koma, opsional)"),
            "adab, ilmu",
        );
