...
const { requestJson, postJson, putJson, deleteJson } = require("../api/client");
const {
    getBookmarks,
    addBookmark,
    deleteBookmark,
...
describe("personal api", () => {
    ...
    describe("library progress", () => {
        ...
        test("getLibraryProgressList picks progress items", async () => {
            ...
            expect(result).toEqual([
                { id: 1, library_book_id: 7, status: "reading" },
            ]);
        });
    });
    ...
    describe("notifications", () => {
        test("getNotificationSettings calls correct endpoint", async () => {
            ...
            expect(result).toEqual([{ type: "prayer", is_active: true }]);
        });
    ...
    describe("hafalan", () => {
        test("getHafalanList calls correct endpoint", async () => {
            ...
            expect(result).toEqual([{ surah_id: 1, status: "completed" }]);
        });
